...
<?php include (dirname(__FILE__) . '/slots/head.php'); ?>
                    ...
                    <div class="row">
                        <div class="small-12 large-9 columns">
                            <div class="row">
                                ...
                                <div>
                                    <h2 class="statistics-header">Samtliga resultat</h2>
                                    <a id="allResults" class="hidden open-close-result" href="#">Öppna</a>
                                    <div id="allResultsDiv" class="statistics-panel small-12 columns">
                                        <?php if($statistics -> getNbrOfResults() == 0): ?>
                                            <div class="row">
                                                <p class="text-centered small-12 columns">Du har inte gjort några quiz</p>
                                            </div>
                                        <?php endif; ?>
                                        <?php if($statistics -> getNbrOfResults() != 0): ?>
                                            <div class="row">
                                                <label class="statistics-header small-8 large-6 columns">Antal resultat: </label>
                                                <p class="small-4 large-6 columns"><?php echo $statistics -> getNbrOfResults(); ?></p>
                                            </div>
                                            <div class="row">
                                                <label class="statistics-header small-8 large-6 columns">Genomsnittlig andel rätt: </label>
                                                <p class="small-4 large-6 columns"><?php echo round($statistics -> getAverageScoreInPercent()); ?>%</p>
                                            </div>
                                        <?php endif; ?>
                                    </div>
                                </div>
                                <div>
                                    <h2 id="coursesResultsHeader" class="statistics-header">Resultat kurser</h2>
                                    <a id="coursesResults" class="hidden open-close-result" href="#">Öppna</a>
                                        ...
                                        <?php foreach ($courses as $course): ?>
                                            ...
                                            <div class="statistics-panel small-12 columns">
                                                <?php if($statistics -> getNbrOfResultsByCourseId($course -> getId()) == 0): ?>
                                                    <div class="row">
                                                        <p class="text-centered small-12 columns">Du har inte gjort några quiz i den här kursen</p>
                                                    </div>
                                                <?php endif; ?>
                                                <?php if($statistics -> getNbrOfResultsByCourseId($course -> getId()) != 0): ?>
                                                    <div class="row">
                                                    ...
                                                    <?php foreach ($course -> getQuiz() as $quiz): ?>
                                                        ...
                                                        <div class="statistics-quiz-panel small-12 columns">
                                                            <?php if($statistics -> getNbrOfResultsByQuizId($quiz -> getId()) == 0): ?>
                                                                <div class="row">
                                                                    <p class="text-centered small-12 columns">Du har inte gjort det här quizet</p>
                                                                </div>
                                                            <?php endif; ?>
                                                            <?php if($statistics -> getNbrOfResultsByQuizId($quiz -> getId()) != 0): ?>
                                                                <div class="row">
    ...
    <script src='<?php echo dirname($_SERVER['PHP_SELF']); ?>/js/site/statisticsStudent.js'></script>
    <script>
        $(document).foundation();
    </script>
    </body>
